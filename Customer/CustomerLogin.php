...
<link rel="stylesheet" href="CustomerLogin.css" media="screen">
  ...
  <div class="u-align-left u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-text-white u-icon-1"><img src="images/1828479-ef71c44b.png" alt=""></span><span class="u-file-icon u-icon u-text-white u-icon-2"><img src="images/1077114-41ae8903.png" alt=""></span>
        <h2 class="u-align-center u-custom-font u-font-montserrat u-text u-text-body-alt-color u-text-1">Sign In</h2>
      </div></header>
    <section class="u-clearfix u-custom-color-10 u-section-1" id="sec-ae5d">
      <div class="u-clearfix u-sheet u-sheet-1">
      
        <div class="u-align-left u-container-style u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-shape-rectangle u-white u-group-1">
          <div class="u-container-layout u-valign-top-md u-container-layout-1">
            <div class="u-container-style u-custom-color-9 u-expanded-width u-group u-shape-rectangle u-group-2">
              <div class="u-container-layout u-valign-bottom-lg u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-container-layout-2">
                ...
                <div class="u-expanded-width-sm u-expanded-width-xs u-form u-login-control u-form-1">
                  <form action="checklogin.php" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-31 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 32px;">
                    <div class="u-form-group u-form-name u-label-top">
                      <label for="username-a30d" class="u-custom-font u-font-montserrat u-label u-label-1">Email *</label>
                      <input type="text" placeholder="Enter your email" id="username-a30d" name="email" class="u-border-2 u-border-white u-input u-input-rectangle u-radius-50 u-white u-input-1" required="">
                    </div>
                    <div class="u-form-group u-form-password u-label-top">
                      <label for="password-a30d" class="u-custom-font u-font-montserrat u-label u-label-2">Password *</label>
                      <input type="text" placeholder="Enter your Password" id="password-a30d" name="password" class="u-border-2 u-border-white u-input u-input-rectangle u-radius-50 u-white u-input-2" required="">
                    </div>
                    <div class="u-form-checkbox u-form-group u-label-top">
                      <input type="checkbox" id="checkbox-a30d" name="remember" value="On">
                      <label for="checkbox-a30d" class="u-custom-font u-font-montserrat u-label u-label-3">Remember me</label>
                    </div>
                    <div class="u-align-left u-form-group u-form-submit u-label-top">
                      <input type="submit" value="submit" class="u-form-control-hidden">
                      <a href="#" class="u-active-white u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-7 u-hover-white u-radius-50 u-text-active-palette-2-base u-text-hover-palette-2-base u-btn-1">Login</a>
                    </div>
            ...
            <a class="u-custom-font u-font-montserrat u-text u-text-custom-color-7 u-text-default u-text-2" href="Forgot.php">Forgot Password?</a>
            <a class="u-custom-font u-font-montserrat u-text u-text-custom-color-7 u-text-default u-text-3" href="CustomerSignUp.php?key=".$email.">Don't Have an account?</a>
