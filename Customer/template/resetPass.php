            ...
            <div class="u-form u-form-1">
              <form action="processCust.php" method="POST" class="u-clearfix u-form-spacing-16 u-inner-form" source="custom" name="form" style="padding: 31px;">
				...
				if($_GET['key']){
                  ...
                  <input type="text" placeholder="Enter new password" id="email-cf71" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div>
                <div class="u-form-group u-form-name u-form-group-2">
                  <label for="name-4cba" class="u-label">Confirm Password</label>
                  <input type="text" placeholder="Confirm your password" id="name-4cba" name="confirmPass" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div>
                <div class="u-align-left u-form-group u-form-submit">
                  <input type="submit" value="Reset Password" name="resetBtn"  class="u-border-none u-btn u-btn-submit u-button-style u-grey-60 u-btn-1">
                </div>
