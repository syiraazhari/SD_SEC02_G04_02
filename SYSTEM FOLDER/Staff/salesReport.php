...
<html lang="en">
	<head>
		...
		<!-- Favicon -->
		<link rel="icon" href="images/Picture3.gif" type="image/x-icon" />
				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img src="images/Picture3.gif" alt="Company logo" style="width: 80px; max-width: 80px" /><h4 style="margin-left:100px;margin-top:-65px;font-size:30px;">Big Galleys cafe</h4>
								</td>
