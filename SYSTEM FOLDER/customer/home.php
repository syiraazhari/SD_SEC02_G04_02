   ...
   <div class="swiper hero-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <div class="image">
               <img src="uploaded_img/dessert-3.png" alt="">
            </div>
         </div>
      </div>
...
<section class="category">
   ...
   <div class="box-container">
      ...
      <a href="category.php?category=Spaghetti" class="box">
...
<h1 class="title" style="margin-top:50px;">Customer Review</h1>
<div class="container">
    	<div class="card">
    		<div class="card-body">
    			<div class="row">
            ...
            success:function(data)
            {
				...
				var html = '';
					...
					html += '<div class="swiper-wrapper" >'	
						...
						html += '</div>';
						html+='<div class="swiper-review"></div>';
						html += '</div>';
						html += '</div>';
					    html += '</Section>';
            }
