                            ...
                            <div class="col-lg-8" style="margin:auto;">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="POST" >
                                        ...
                                        <input type="submit" name="changePassBtn" value="Submit" class="btn btn-user btn-block" 
										style="background-color: #e2725b ; color: #ffffff;">
                                    </form>
                                <?php
								//print_r($_POST);
								if(isSet($_POST['changePassBtn']))
								{
									...
									$result = $conn->prepare('UPDATE `admin` SET password = ?, confirmPassword= ? WHERE email = ?');
