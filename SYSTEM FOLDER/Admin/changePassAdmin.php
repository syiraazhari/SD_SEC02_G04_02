...
<li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
				<main id="main" class="main" style="margin-left:500px;">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <div class="tab-content pt-3" id="profile-change-password">
                  ...
                  <form action="" method="POST" class="form1">
					...
					<?php
						if(isSet($_POST['changePassBtn']))
						{
							...
							$result = $conn->prepare('UPDATE `admin` SET password = ?, confirmPassword= ? WHERE id = ?');
