...
$email = $_POST['email'];
 $result = $conn->prepare("SELECT * FROM admin WHERE email='" . $email . "'");
 $result->execute();
  ...
  if($result)
  {
        ...
        try {
            ...
            <a href='https://1ab6-175-143-62-154.ap.ngrok.io/Project/latest/Admin/resetPassAdmin.php?key=".$email."'>password</a>";
