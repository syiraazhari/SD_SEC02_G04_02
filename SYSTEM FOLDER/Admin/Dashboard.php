            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="salesReport.php" class="d-none d-sm-inline-block btn btn-sm  shadow-sm" style="background-color: #e2725b; color: #ffffff;"><i
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
											...
											<?php
											$Earnings = $conn->prepare("SELECT Sum(total_price) FROM `orders`");
											$Earnings->execute();
											$fetchEarnings = $Earnings->fetchColumn();
											echo $fetchEarnings;
												?>
											</div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
											...
											<?php
											$numCust = $conn->prepare("SELECT count(id) FROM `orders`");
											$numCust->execute();
											$fetchCust = $numCust->fetchColumn();
											echo $fetchCust;
												?>
											</div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
											...
											$percentOrders = $conn->prepare("SELECT sum(payment_status = 'Success')/count(payment_status) FROM `orders`");
											$percentOrders->execute();
											$fetchPercent = $percentOrders->fetchColumn();
											echo $fetchPercent;
												?>%</div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
											<?php
											$select_orders = $conn->prepare("SELECT count(payment_status) FROM `orders` where payment_status = 'pending'");
											$select_orders->execute();
											$fetch_carts = $select_orders->fetchColumn();
											echo $fetch_carts;
												?>
											</div>
                                        </div>
